                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox" id="new" checked>
                                <label for="new" class="custom-control-label">New Patient</label>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <textarea v-model="form.address" class="form-control" rows="3" placeholder="Address ..."></textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="input-group mb-3">
                                <input v-model="dob" class="form-control" type="text" placeholder="Date of Birth">
                            </div>
                            <div class="input-group mb-3">
                                <input v-model="weight" class="form-control text-right" type="number" placeholder="Weight">
                            </div>
                            <div class="input-group mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-3">
                                <input v-model="height" class="form-control text-right" type="number" placeholder="Height">
                            </div>
                        </div>
                    </div>
                </div>
